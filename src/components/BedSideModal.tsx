...
const BedsideBookingDetailsModal: React.FC<BedsideBookingDetailsModalProps> = ({
  ...
  const handleViewReports = () => {
    ...
    navigate(`/admin/bedside-reports/${booking.id}/inpatient`);
  };
    ...
    <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="border-t border-gray-200 p-6 bg-gray-50 flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-semibold hover:bg-gray-50 transition-colors"
          >
            Close
          </button>
          <button
            onClick={handleViewReports}
            className="flex-1 bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors shadow-sm"
          >
            View Reports
          </button>
        </div>
