...
import { Shield, CheckCircle, XCircle, Clock, X } from "lucide-react";
import RecordCareTreatmentModal from "./RecordCareTreatmentModal";
...
const CareBookingVerifySessionModal = ({ booking_id, close }: valueProp) => {
  ...
  useEffect(() => {
    if (verificationStatus === "success") return; // Stop timer when verified
  ...
  return (
    <>
      <div className="min-h-screen absolute inset-0 bg-white flex items-center justify-center p-4">
