...
const PatientsTable: React.FC<PatientsTableProps> = ({ patients, role }) => {
  ...
  const handleViewClick = (patient: Patient) => {
    setSelectedUser({ id: patient.id, name: patient.full_name });
    setModalOpen(true);
  };
                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center space-x-1 text-gray-600 hover:text-blue-600 transition-colors duration-200"
                          >
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-gray-500 pt-2 border-t border-gray-100">
                    {isPatient ? "Patient" : "Worker"} ID: {patient.id}
                  </div>
                </div>
              </div>
            ))}
